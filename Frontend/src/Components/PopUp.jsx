          ...
          <div className="flex justify-center gap-3 md:gap-5 mt-6">
            {buttons.length === 0 ? (
              <div className="flex gap-4">
                <a onClick={onClose} href="https://www.instagram.com/201harshs/">
                ...
                <button onClick={onClose} className="bg-yellow-400 cursor-pointer hover:bg-yellow-500 text-gray-900 font-medium py-2 px-6 rounded-lg transition-all duration-200">
                  Follow Later
                </button>
              </div>
            ) : (
