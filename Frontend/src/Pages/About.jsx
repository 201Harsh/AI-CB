...
const milestones = [
  {
    year: "2021",
    title: "Concept Born",
    description: "Initial research into emotional AI began with academic partnerships."
  },
  {
    year: "2022",
    title: "Beta Launch",
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <section className="text-center mb-20">
          ...
          >
            We're on a mission to create AI that doesn't just respond, but truly understands and connects with people on an emotional level.
          </motion.p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-300 mb-4">
                Founded in 2021, EmoAI began as a research project at the intersection of artificial intelligence and emotional psychology. Our team recognized that while AI was becoming increasingly capable, it lacked the emotional intelligence that makes human interactions meaningful.
              </p>
              <p className="text-gray-300 mb-4">
                We set out to change that by developing the world's first truly emotionally intelligent AI system - one that could understand context, recognize emotional states, and respond with genuine empathy.
              </p>
              <p className="text-gray-300">
                Today, EmoAI serves millions of users worldwide, helping them with everything from mental wellness to professional development, all through the power of emotionally aware conversation.
              </p>
            </div>
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              <h3 className="text-xl font-semibold text-yellow-400 mb-4">Our Mission</h3>
              <p className="text-gray-300 mb-6">
                To create AI companions that enhance human well-being through emotionally intelligent interactions.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">We prioritize real human needs over technological炫耀</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Responsible development with strict ethical guidelines</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Designed to serve diverse cultures and communities</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <motion.section 
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-yellow-400 mb-8">Our Journey</h2>
            ...
            {milestones.map((milestone, index) => (
              <div key={index} className={`relative mb-12 ${index % 2 === 0 ? 'md:text-left' : 'md:text-right'}`}>
                <div className={`flex flex-col md:flex-row items-center ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:text-left'} order-1 md:order-none`}>
                    <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                      <h3 className="text-xl font-semibold text-yellow-400">{milestone.title}</h3>
        ...
        <motion.section 
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-yellow-400 mb-8">Meet the Team</h2>
        ...
        >
          <h3 className="text-3xl font-bold text-yellow-400 mb-6">Join Our Mission</h3>
