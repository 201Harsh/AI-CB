...
export default function AuthPrompt() {
  return (
    <div className="min-h-screen bg-[url('/bg26.jpg')] bg-cover bg-center flex items-center justify-center px-4 py-12">
      ...
      <div className="relative max-w-md w-full bg-gray-900/50 backdrop-blur-lg rounded-xl shadow-2xl overflow-hidden border border-gray-700/50 transform transition-all hover:scale-[1.01] duration-300">
        {/* Glow effect */}
